...
def get_dev_scores_voice_data_file_path():
    return os.path.join(get_devranker_dir(), 'dev_scores_voice-data-backend.git.csv')
...
def show_charts():
    anonymized_predictions_data = pandas.read_csv(get_dev_scores_voice_data_file_path())
    print(anonymized_predictions_data)
